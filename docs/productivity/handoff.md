...
Type `/handoff`, or the agent reaches for it when context needs to travel to another session, directory, harness, or colleague. Pass a note about what the next session is for, and the document is written for it.

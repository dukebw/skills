...
Type `/triage`, or the [agent](https://www.aihero.dev/ai-coding-dictionary/agent) reaches for it when you ask to sort incoming issues or external PRs. Describe what you want in plain language: "Show me anything that needs my attention", "let's look at #42", "move #42 to ready-for-agent".

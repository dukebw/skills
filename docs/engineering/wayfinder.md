...
Type `/wayfinder`, or the [agent](https://www.aihero.dev/ai-coding-dictionary/agent) reaches for it when planning genuinely requires a multi-session decision map.

...
Type `/improve-codebase-architecture`, or the [agent](https://www.aihero.dev/ai-coding-dictionary/agent) reaches for it when the task calls for an architecture survey.

...
Type `/implement`, or the agent reaches for it when the requested work is ready to build from a spec or tickets. Other skills can call it too; invocation does not authorize work outside the user's request.

...
The promoted skills are **model-invoked**: you can type their names (e.g. `/grill-me`), or the agent can reach for them when the task fits. Automatic invocation does not expand the work you authorized or bypass a skill's confirmation gates.
